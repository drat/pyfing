...
def optimize_parameters_on_db(year, db, subset, images, gt):
    ...
    p = pf.GradMagSegmentationParameters(0, 0, 0, 1, 2, dpi)
    ...
    best_parameters.save(f'{PATH_RES}fvc{year}_db{db}_b_{pf.GradMagSegmentationAlgorithm.__name__}_params.json')
